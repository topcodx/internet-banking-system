...
if (isset($_POST['update_client_account'])) {
    ...
    $rc = $stmt->bind_param('ssssssi', $name, $national_id, $phone, $email,  $address, $profile_pic, $client_id);
    $stmt->execute();
...
if (isset($_POST['change_client_password'])) {
    ...
    $client_number = isset($_GET['client_number']) ? $_GET['client_number'] : null; // Handle case where client_number is not set
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="update_Profile">
                                            <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputName2" class="col-sm-2 col-form-label">National ID
                                                        Number</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" required readonly
                                                            name="national_id" value="<?php echo $row->national_id; ?>"
                                                            id="inputName2">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
