...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="staff/pages_staff_index.php">Staff Portal</a>
                    </li>
                    <li class="nav-item active">
    ...
    <div class="intro py-5 py-lg-9 position-relative text-white">
        <div class="bg-overlay-gray" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%;">
            <img src="dist/bank.webp" class="img-fluid img-cover" style="height: 100vh;" />
        </div>
