            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="payAmount" id="payAmount" value="10"
                    ...
                    if (data.res == 'success') {
                        ...
                        var options = {
                            ...
                            "handler": function (response) {
                                ...
                                window.location.replace("http://localhost/internet-banking-system/payment-success.php?oid=" + orderID + "&rp_payment_id=" + response.razorpay_payment_id + "&rp_signature=" + response.razorpay_signature);
                            },
                            "modal": {
                                "ondismiss": function () {
                                    window.location.replace("http://localhost/internet-banking-system/payment-success.php?oid=" + orderID);
                                }
                            },
                        ...
                        rzp1.on('payment.failed', function (response) {
                            ...
                            window.location.replace("http://localhost/internet-banking-system/payment-failed.php?oid=" + orderID + "&reason=" + response.error.description + "&paymentid=" + response.error.metadata.payment_id);
